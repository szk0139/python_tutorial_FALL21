...
def compute_windchill(t, v):
    """   
    Compute the windchill factor given the temperature and wind speed 

    Note: This computation is only valid between -45F to +45F
          and for wind speed between 3mph and 60 mph
...
def compute_heatindex(t, hum):
    ...
    Parameters:
        t = The temperature in units of F (Float)
        hum = the relative humidity in uniots of % (Float)
